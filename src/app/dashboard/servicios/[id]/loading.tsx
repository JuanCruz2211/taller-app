  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mt-4 animate-pulse">
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="mt-1 h-4 w-48 rounded-lg bg-zinc-200 dark:bg-zinc-800" />
          </div>
          <div className="flex items-center gap-2">
            <div className="h-10 w-24 rounded-xl bg-zinc-200 dark:bg-zinc-700" />
            <div className="h-10 w-32 rounded-xl bg-blue-200 dark:bg-blue-900" />
          </div>
        </div>
      </div>

      <div className="mt-6 grid animate-pulse gap-6 sm:grid-cols-2">
      ...
      <div className="mt-6 animate-pulse rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-4 h-40 w-full rounded-xl bg-zinc-100 dark:bg-zinc-800" />
      </div>
    </div>
  );
}
